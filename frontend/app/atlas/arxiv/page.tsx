...
import freeArtifactRaw from "@/data/showcases/atlas/arxiv_artifact.json";
import premiumArtifactRaw from "@/data/showcases/atlas/arxiv_artifact_pro.json";
...
const sources = (() => {
  try {
    const text = readFileSync(join(STDLIB, "atlas.ocean"), "utf-8");
...
export default function AtlasArxivPage() {
  return (
    <>
      <Nav />
      <main className="max-w-6xl mx-auto px-6 pt-32 pb-16">
        <ShowcaseHeader
          namespace="atlas"
          dataset="arxiv"
          title="Atlas: arXiv Preprints"
          tagline="Cross-category structural clustering across 500 arXiv abstracts."
          labelField="category"
          free={freeArtifact}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
          <ShowcaseArtifactPanel artifact={freeArtifact} tier="free" labelField="category" />
          <ShowcaseArtifactPanel artifact={premiumArtifact} tier="premium" labelField="category" />
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <ShowcaseSourcePanel source={sources.free} presetName="atlas.arxiv" tier="free" />
          <ShowcaseSourcePanel source={sources.premium} presetName="atlas.arxiv_pro" tier="premium" />
        </div>
        <ShowcaseFooter presetName="atlas.arxiv" />
      </main>
    </>
  );
}
