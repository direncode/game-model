...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const message = err.errors?.[0]?.longMessage || err.message || "Invalid credentials";
      toast.error(message);
    } finally {
      setLoading(false);
    }
    ...
    <div className="w-full max-w-md">
      ...
      <div className="space-y-3 mb-6">
        <button
          ...
          className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-li-surface border border-li-gray-800 rounded-lg text-sm text-white hover:bg-white/5 hover:border-li-gray-600 transition-colors"
        >
      ...
      <div className="flex items-center gap-4 mb-6">
        <div className="flex-1 h-px bg-li-gray-800" />
        <span className="text-xs text-li-text-muted">or</span>
        <div className="flex-1 h-px bg-li-gray-800" />
      </div>
