...
const VERTICALS = [
  { name: "Threat Intelligence", accent: "#00d4ff", description: "Air-gapped intrusion detection with bit-identical replay against real telemetry", tag: "Zeek · Sysmon · NetFlow · EDR", href: "/console?vertical=cyber", cta: "Open Console" },
