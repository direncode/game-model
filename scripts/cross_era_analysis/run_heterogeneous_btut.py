"""Run standalone BTUT pipeline on the heterogeneous cross-era corpus."""
...
def main():
    payload_path = Path("/app/scripts/heterogeneous_corpus.json")
    ...
    out_path = Path("/tmp/heterogeneous_btut_result.json")
