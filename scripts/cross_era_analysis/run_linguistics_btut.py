"""Run standalone BTUT pipeline on the linguistics corpus."""
...
def main():
    with open("/app/scripts/linguistics_corpus.json", "r") as f:
        data = json.load(f)
    ...
    print("Running BTUT pipeline on linguistics corpus...")
    ...
    out_path = "/tmp/linguistics_btut_result.json"
