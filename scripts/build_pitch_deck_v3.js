// v3 — restructured per user direction:
//   - Final CTA slide removed (deck closes on Defensibility)
//   - Slide 1: URL replaces date placeholder, new email (direnavk@outlook.com)
//   - Footer "CONFIDENTIAL" removed
//   - Expanded to 4 dedicated screenshot slides (Landing / Platform / Titan / Live)
//
// Run: node scripts/build_pitch_deck_v3.js
// Output: docs/commercial/latent-ocean-pitch-v3.pptx
...
// Helper for all 4 screenshot slides
// Source images are 3200x1880 (aspect 1.702). Slide is 10x5.625 with footer at y=5.25.
// Layout: section label + small headline + max-height screenshot + tight caption.
function addScreenshotSlide(slide, slideNum, sectionTag, headline, screenshotPath, caption) {
  ...
  // Big screenshot — height-constrained, centered horizontally
  const imgH = 3.85;
  const ASPECT = 3200 / 1880; // 1.702
...
// ════════════════════════════════════════════════════════════════════
// SLIDE 8 (NEW): SEE IT WORK · LANDING
// ════════════════════════════════════════════════════════════════════
addScreenshotSlide(
  pres.addSlide(),
  8,
...
// ════════════════════════════════════════════════════════════════════
// SLIDE 9 (NEW): SEE IT WORK · PLATFORM
// ════════════════════════════════════════════════════════════════════
addScreenshotSlide(
  pres.addSlide(),
  9,
  "SEE IT WORK  ·  PLATFORM",
...
// ════════════════════════════════════════════════════════════════════
// SLIDE 10 (NEW): SEE IT WORK · TITAN
// ════════════════════════════════════════════════════════════════════
addScreenshotSlide(
  pres.addSlide(),
  10,
...
// ════════════════════════════════════════════════════════════════════
{
  ...
  slide.addText(
    ...
    ],
    {
      ...
      color: "FFFFFF", paraSpaceAfter: 22,
      margin: 0,
    }
  );
...
// ────────── SAVE ──────────
pres
  .writeFile({ fileName: "docs/commercial/latent-ocean-pitch-v3.pptx" })
