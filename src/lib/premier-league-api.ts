...
export function getPLSquadData(teamTla: string): Player[] {
  const squads: Record<string, Player[]> = {
    ...
    MUN: [
      { id: 'mun-1', name: 'Andre Onana', number: 24, position: 'GK', preferredFoot: 'right', physicalProfile: { maxSpeed: 26, accelerationPeak: 3.2, sprintCapacity: 185, highIntensityThreshold: 18, aerobicThreshold: 145, anaerobicThreshold: 170 }, currentStatus: 'available' },
      ...
      { id: 'mun-5', name: 'Luke Shaw', number: 23, position: 'LB', preferredFoot: 'left', physicalProfile: { maxSpeed: 32, accelerationPeak: 4.0, sprintCapacity: 370, highIntensityThreshold: 20, aerobicThreshold: 154, anaerobicThreshold: 179 }, currentStatus: 'available' },
      { id: 'mun-6', name: 'Casemiro', number: 18, position: 'CDM', preferredFoot: 'right', physicalProfile: { maxSpeed: 29, accelerationPeak: 3.5, sprintCapacity: 270, highIntensityThreshold: 18, aerobicThreshold: 147, anaerobicThreshold: 172 }, currentStatus: 'available' },
      ...
      { id: 'mun-9', name: 'Mason Mount', number: 7, position: 'CM', preferredFoot: 'right', physicalProfile: { maxSpeed: 31, accelerationPeak: 3.9, sprintCapacity: 345, highIntensityThreshold: 19.5, aerobicThreshold: 153, anaerobicThreshold: 178 }, currentStatus: 'available' },
      { id: 'mun-10', name: 'Marcus Rashford', number: 10, position: 'LW', preferredFoot: 'right', physicalProfile: { maxSpeed: 35, accelerationPeak: 4.5, sprintCapacity: 460, highIntensityThreshold: 22, aerobicThreshold: 160, anaerobicThreshold: 185 }, currentStatus: 'available' },
      { id: 'mun-11', name: 'Alejandro Garnacho', number: 17, position: 'LW', preferredFoot: 'right', physicalProfile: { maxSpeed: 34, accelerationPeak: 4.4, sprintCapacity: 440, highIntensityThreshold: 21.5, aerobicThreshold: 159, anaerobicThreshold: 184 }, currentStatus: 'available' },
      ...
      { id: 'mun-13', name: 'Rasmus Hojlund', number: 9, position: 'ST', preferredFoot: 'right', physicalProfile: { maxSpeed: 34.5, accelerationPeak: 4.4, sprintCapacity: 450, highIntensityThreshold: 21.5, aerobicThreshold: 159, anaerobicThreshold: 184 }, currentStatus: 'available' },
      { id: 'mun-14', name: 'Joshua Zirkzee', number: 11, position: 'ST', preferredFoot: 'right', physicalProfile: { maxSpeed: 32, accelerationPeak: 4.0, sprintCapacity: 360, highIntensityThreshold: 20, aerobicThreshold: 155, anaerobicThreshold: 180 }, currentStatus: 'available' },
    ],
  };
