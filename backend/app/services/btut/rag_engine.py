...
class RAGEngine:
    ...
    async def fetch_and_index(
        ...
        # Fetch documents based on dataset
        ...
        if dataset_id == "edgar":
            ...
            # Generic: use entity attributes as a single document
    ...
    async def _index_chunks(
        ...
        try:
            ...
            # Delete existing chunks for this entity+source first
    ...
    def _fetch_edgar_sources(
        ...
        # Get submissions to find latest filings
        ...
        # Find the latest 10-K and up to 2 recent 8-Ks
        ten_k_found = False
        eight_k_count = 0
    ...
    def _fetch_pubmed_sources(
        ...
        if entity_type == "paper" and pmid:
            ...
            if author_name:
                # Search for recent papers by this author
