...
from app.api.v1.fde import router as fde_router
from app.api.v1.lsu import router as lsu_router
...
router.include_router(fde_router)
router.include_router(lsu_router)
